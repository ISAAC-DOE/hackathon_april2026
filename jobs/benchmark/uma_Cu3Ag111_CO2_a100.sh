#!/bin/bash
#SBATCH --job-name=uma_Cu3Ag111_CO2_a100
...
#SBATCH --output=/sdf/home/d/dsokaras/hackathon_april2026/logs/benchmark/uma_Cu3Ag111_CO2_a100-%j.out
#SBATCH --error=/sdf/home/d/dsokaras/hackathon_april2026/logs/benchmark/uma_Cu3Ag111_CO2_a100-%j.err
