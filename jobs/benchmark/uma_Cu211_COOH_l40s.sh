#!/bin/bash
#SBATCH --job-name=uma_Cu211_COOH_l40s
...
#SBATCH --output=/sdf/home/d/dsokaras/hackathon_april2026/logs/benchmark/uma_Cu211_COOH_l40s-%j.out
#SBATCH --error=/sdf/home/d/dsokaras/hackathon_april2026/logs/benchmark/uma_Cu211_COOH_l40s-%j.err
